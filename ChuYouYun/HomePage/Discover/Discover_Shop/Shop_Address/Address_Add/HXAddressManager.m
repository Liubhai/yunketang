...
- (NSArray *)provinceDicAry {
    if (!_provinceDicAry) {
        NSString *path = [[NSBundle mainBundle] pathForResource:@"GLaddress" ofType:@"plist"];
        NSDictionary*addressDic = [[NSDictionary alloc] initWithContentsOfFile:path];
        
        _provinceDicAry=[addressDic objectForKey:@"address"];
