//
//  ClassSearchGoodViewController.h
//  dafengche
//
...
@interface ClassSearchGoodViewController : UIViewController
...
@property (strong ,nonatomic)NSString *currentVipId;//当前会员的ID


//判断是否是在最外面的洁面
@property (strong ,nonatomic)NSString     *typeTagStr;
