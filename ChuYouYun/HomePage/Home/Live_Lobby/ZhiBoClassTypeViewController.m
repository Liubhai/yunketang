...
- (void)addTabView {
    ...
    _oneTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, MainScreenWidth, MainScreenHeight - 109 - 200) style:UITableViewStyleGrouped];
    if (iPhoneX) {
        _oneTableView.frame = CGRectMake(0, 26, MainScreenWidth, MainScreenHeight - 109 - 26 - 200);
    }
