...
- (void)addAllView {
    _tabView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MainScreenWidth,40 * _dataArray.count)];
    if (iPhoneX) {
        _tabView.frame = CGRectMake(0, 24, MainScreenWidth, 280);
    }
...
- (void)addTabView {
    ...
    _oneTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, MainScreenWidth, _dataArray.count * 40) style:UITableViewStyleGrouped];
    if (iPhoneX) {
        _oneTableView.frame = CGRectMake(0, 24, MainScreenWidth, 7 * 40);
    }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_oneTableView == tableView) {//点击一级分类的时候
        ...
        [UIView animateWithDuration:0.25 animations:^{
            _oneTableView.frame = CGRectMake(0, 0, MainScreenWidth / 2, 7 * 40);
