...
//    NSArray *titleArray = @[@"直播",@"点播",@"线下课",@"帖子"];
    NSArray *titleArray = @[@"直播",@"点播",@"线下课",@"机构",@"资讯"];
    CGFloat ButtonH = 20;
...
//    topicVc.view.frame = CGRectMake(MainScreenWidth * 3, -98, MainScreenWidth, MainScreenHeight);
//    [self addChildViewController:topicVc];
//    [_controllerSrcollView addSubview:topicVc.view];
    

    CollectInsViewController * instVc = [[CollectInsViewController alloc]init];
    instVc.view.frame = CGRectMake(MainScreenWidth * 3, -98, MainScreenWidth, MainScreenHeight);
    ...
    newsVc.view.frame = CGRectMake(MainScreenWidth * 4, -98, MainScreenWidth, MainScreenHeight);
