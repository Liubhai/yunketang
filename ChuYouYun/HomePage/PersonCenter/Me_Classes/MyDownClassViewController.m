...
@interface MyDownClassViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)addTableView {
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 64 + 34, MainScreenWidth, MainScreenHeight - 64 - 34) style:UITableViewStyleGrouped];
    if (iPhoneX) {
        _tableView.frame = CGRectMake(0, 88 + 34, MainScreenWidth, MainScreenHeight - 88 - 34);
    }
...
- (void)netWorkUserLineVideoGetMyList:(NSInteger)Num {
    ...
    [mutabDict setValue:@"5" forKey:@"count"];
