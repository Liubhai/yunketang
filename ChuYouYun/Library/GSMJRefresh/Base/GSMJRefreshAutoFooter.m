...
@interface GSMJRefreshAutoFooter()
@property (strong, nonatomic) UIPanGestureRecognizer *pan;
@end

@implementation GSMJRefreshAutoFooter
...
- (void)scrollViewContentOffsetDidChange:(NSDictionary *)change
{
    ...
    if (self.state != GSMJRefreshStateIdle || !self.automaticallyRefresh || self.mj_y == 0) return;
