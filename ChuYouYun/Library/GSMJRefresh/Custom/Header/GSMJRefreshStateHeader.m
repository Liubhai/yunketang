...
@interface GSMJRefreshStateHeader()
{
    /** 显示上一次刷新时间的label */
...
@implementation GSMJRefreshStateHeader
#pragma mark - 懒加载
...
- (void)prepare
{
    ...
    // 初始化文字
    [self setTitle:GSMJRefreshHeaderIdleText forState:GSMJRefreshStateIdle];
    [self setTitle:GSMJRefreshHeaderPullingText forState:GSMJRefreshStatePulling];
    [self setTitle:GSMJRefreshHeaderRefreshingText forState:GSMJRefreshStateRefreshing];
}
