...
//        return playerItem;
        ...
        [headers setObject:@"REQUEST_HEADER_REFERER"forKey:@"Referer"];
        AVURLAsset *urlAsset = [AVURLAsset URLAssetWithURL:urlString options:@{@"AVURLAssetHTTPHeaderFieldsKey" : headers}];
        // 初始化playerItem
...
//        self.currentItem = [AVPlayerItem playerItemWithURL:[NSURL URLWithString:videoURLStr]];
