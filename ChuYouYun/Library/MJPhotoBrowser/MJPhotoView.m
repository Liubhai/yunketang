...
- (void)photoStartLoad
{
    if (_photo.image) {
        ...
        //这里 我自己改了的  （这里不是 明杰的）
        [_imageView sd_setImageWithPreviousCachedImageWithURL:_photo.url andPlaceholderImage:_photo.srcImageView.image options:SDWebImageRetryFailed|SDWebImageLowPriority  progress:^(NSInteger receivedSize, NSInteger expectedSize) {
