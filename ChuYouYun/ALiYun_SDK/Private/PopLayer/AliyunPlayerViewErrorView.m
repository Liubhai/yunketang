...
- (UIButton *)button{
    if (!_button) {
        ...
        [_button setBackgroundImage:[AliyunUtil imageWithNameInBundle:@"al_error_btn" skin:AliyunVodPlayerViewSkinBlue] forState:UIControlStateNormal];
        [_button setImage:[AliyunUtil imageWithNameInBundle:@"al_over_btn_refresh" skin:AliyunVodPlayerViewSkinBlue] forState:UIControlStateNormal];
...
-(void)setSkin:(AliyunVodPlayerViewSkin)skin{
    ...
    [self.button setImage:[AliyunUtil imageWithNameInBundle:@"al_over_btn_refresh" skin:skin] forState:UIControlStateNormal];
