...
- (void)hiddenView{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"PlayButtonHidden" object:@"1"];
    [NSObject cancelPreviousPerformRequestsWithTarget:self selector:@selector(delayHideControlLayer) object:nil];
}
...
- (void)showView{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"PlayButtonShow" object:@"1"];
